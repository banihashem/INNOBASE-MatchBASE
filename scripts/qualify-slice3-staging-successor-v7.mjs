...
const AUTHORIZATION_ID =
  "OWNER-SLICE3-STAGING-LIVE-QUALIFICATION-2026-08-30-V7";
const EXECUTION_SIGNAL = "I_AUTHORIZE_SYNTHETIC_STAGING_QUALIFICATION_V7";
const AUTHORIZATION_SHA256 =
  "E19792C40649997DF7A724D0A808AD7AC298EF069B8AC3F8D176687E740D6697";
const PRODUCTION_POLICY_SHA256 =
  "46FCAF0C2D2B66F8BAB8526C48E448A24B2E9F65B065AAA99135CA6AF048DB23";
const PREDECESSOR_SESSION_ID = "v6-B16E0EB676127D5C326D577B";
const PREDECESSOR_LEDGER_SHA256 =
  "C0FBD820AC13D032A017DA77C15B615AE609138D2C7B2250EFF54BA1E9301AE5";
...
const SESSION_ID = "v6-2E66ED1C86D901D252F99B5E";
const MAX_EXTERNAL_HTTP_CALLS = 50;
const MAX_MODEL_POSTS = 2;
const MAX_COST_USD = 99.3069855;
const PRIOR_MODEL_POSTS = 17;
const PRIOR_COST_USD = 0.6930145;

const DEFAULTS = Object.freeze({
  authorizationPath: resolve(
    "governance/slice3-staging-live-qualification-successor-authorization.v7.json",
  ),
  productionPolicyPath: resolve("config/slice3/research-route-policy.v1.json"),
  credentialPath: resolve("APIKeys.md"),
  executorPath: resolve("scripts/qualify-slice3-staging-successor-v7.mjs"),
...
function validateAuthorization(value) {
  if (
    value?.schemaVersion !==
      "matchbase.slice3-staging-live-qualification-successor-authorization/v7" ||
    ...
    value.predecessor?.cumulativeProviderModelPosts !== 17 ||
    value.predecessor?.cumulativeConservativeCostUsd !== 0.6930145 ||
    ...
    value.ownerCeiling?.remainingProviderCallsBeforeV7 !== 33 ||
    value.ownerCeiling?.remainingCostUsdBeforeV7 !== MAX_COST_USD ||
    ...
    value.accounting?.providerModelPostsBeforeV7 !== PRIOR_MODEL_POSTS ||
    value.accounting?.conservativeCostUsdBeforeV7 !== PRIOR_COST_USD ||
...
export async function assessSuccessor(overrides = {}) {
  ...
  return Object.freeze({
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-preflight/v7",
    disposition:
...
function sanitizedFailure(error, routePath, counters) {
  ...
  return Object.freeze({
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-failure/v7",
...
export async function executeSuccessor({
  ...
  await writeJsonExclusive(join(stateDirectory, "00-authorization.json"), {
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-session/v7",
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
    predecessorSessionId: PREDECESSOR_SESSION_ID,
    syntheticOnly: true,
  ...
  for (
    ...
    await writeJsonExclusive(
      ...
      {
        schemaVersion:
          "matchbase.slice3-staging-live-qualification-successor-reservation/v7",
        authorizationId: AUTHORIZATION_ID,
        sessionId: SESSION_ID,
        callNumber: index + 1,
  ...
  await writeJsonExclusive(join(stateDirectory, "05-terminal-summary.json"), {
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-terminal/v7",
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
  ...
  if (failures.length > 0) {
    ...
    return Object.freeze({
      schemaVersion:
        "matchbase.slice3-staging-live-qualification-successor-execution/v7",
      disposition: "FAIL",
      authorizationId: AUTHORIZATION_ID,
      sessionId: SESSION_ID,
...
export const SLICE3_STAGING_SUCCESSOR_V7_CONSTANTS = Object.freeze({
  authorizationId: AUTHORIZATION_ID,
