...
test("MB-UX-LIVE-001 L14 a later manufacturer-only search preserves legacy seller sources through extraction, publication and continuation", async (t) => {
  ...
  const continuation = {
    ...
    remaining_gaps: ["Seller identity and product evidence remain unconfirmed"],
  };
  ...
  assert.equal(
    requests.length,
    4,
    "Only the four planned mocked calls run; no hidden repair or extra round",
  );
