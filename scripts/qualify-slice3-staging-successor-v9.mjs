...
const AUTHORIZATION_ID =
  "OWNER-SLICE3-STAGING-LIVE-QUALIFICATION-2026-08-30-V9";
const EXECUTION_SIGNAL = "I_AUTHORIZE_SYNTHETIC_STAGING_QUALIFICATION_V9";
const AUTHORIZATION_SHA256 =
  "0BAC898DC864E14D1C6326E7EEC22B091F4F88D54497FA790536BC22B4152FCA";
const PRODUCTION_POLICY_SHA256 =
  "46FCAF0C2D2B66F8BAB8526C48E448A24B2E9F65B065AAA99135CA6AF048DB23";
const PREDECESSOR_SESSION_ID = "v6-8AC279688809D6034291989E";
const PREDECESSOR_LEDGER_SHA256 =
  "B45853C31F41066A36C0D44CBA1F607F864CCDE901890984B70435A8EF154F0D";
...
const SESSION_ID = "v6-140C181D2FF89EE8A41044FB";
const MAX_EXTERNAL_HTTP_CALLS = 50;
const MAX_MODEL_POSTS = 2;
const MAX_COST_USD = 98.8542495;
const PRIOR_MODEL_POSTS = 21;
const PRIOR_COST_USD = 1.1457505;

const DEFAULTS = Object.freeze({
  authorizationPath: resolve(
    "governance/slice3-staging-live-qualification-successor-authorization.v9.json",
  ),
  productionPolicyPath: resolve("config/slice3/research-route-policy.v1.json"),
  credentialPath: resolve("APIKeys.md"),
  executorPath: resolve("scripts/qualify-slice3-staging-successor-v9.mjs"),
...
function validateAuthorization(value) {
  if (
    value?.schemaVersion !==
      "matchbase.slice3-staging-live-qualification-successor-authorization/v9" ||
    ...
    value.predecessor?.cumulativeProviderModelPosts !== 21 ||
    value.predecessor?.cumulativeConservativeCostUsd !== 1.1457505 ||
    ...
    value.ownerCeiling?.remainingProviderCallsBeforeV9 !== 29 ||
    value.ownerCeiling?.remainingCostUsdBeforeV9 !== MAX_COST_USD ||
    ...
    value.accounting?.providerModelPostsBeforeV9 !== PRIOR_MODEL_POSTS ||
    value.accounting?.conservativeCostUsdBeforeV9 !== PRIOR_COST_USD ||
...
export async function assessSuccessor(overrides = {}) {
  ...
  return Object.freeze({
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-preflight/v9",
    disposition:
...
function sanitizedFailure(error, routePath, counters) {
  ...
  return Object.freeze({
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-failure/v9",
...
export async function executeSuccessor({
  ...
  await writeJsonExclusive(join(stateDirectory, "00-authorization.json"), {
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-session/v9",
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
    predecessorSessionId: PREDECESSOR_SESSION_ID,
    syntheticOnly: true,
  ...
  for (
    ...
    await writeJsonExclusive(
      ...
      {
        schemaVersion:
          "matchbase.slice3-staging-live-qualification-successor-reservation/v9",
        authorizationId: AUTHORIZATION_ID,
        sessionId: SESSION_ID,
        callNumber: index + 1,
  ...
  await writeJsonExclusive(join(stateDirectory, "05-terminal-summary.json"), {
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-terminal/v9",
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
  ...
  if (failures.length > 0) {
    ...
    return Object.freeze({
      schemaVersion:
        "matchbase.slice3-staging-live-qualification-successor-execution/v9",
      disposition: "FAIL",
      authorizationId: AUTHORIZATION_ID,
      sessionId: SESSION_ID,
...
export const SLICE3_STAGING_SUCCESSOR_V9_CONSTANTS = Object.freeze({
  authorizationId: AUTHORIZATION_ID,
