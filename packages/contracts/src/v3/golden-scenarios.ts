...
export const GOLDEN_SCENARIO_V3_02: ConsultantResearchOutputV3 = {
  ...
  request_snapshot: {
    ...
    product_attributes: {
      capacity: "500 Litres",
      working_pressure: "Minimum 10 bar (tested >= 15 bar)",
      ...
      controls: "BMS-compatible thermostat integration",
    ...
    normalized_requirements: [
      ...
      },
      {
        ...
        value: "Indoor mechanical room",
        requirement_level: "mandatory",
      },
      {
        name: "Thermal Insulation",
        value: "Documented thermal insulation",
        requirement_level: "mandatory",
      },
      {
        name: "Safety Valve Compatibility",
        value: "Safety-valve compatibility",
        requirement_level: "mandatory",
      },
      {
        name: "Thermostat Controls",
        value: "BMS-compatible thermostat",
        requirement_level: "mandatory",
      },
      {
      ...
      },
      {
        ...
        value: "Two-year UAE warranty (24 months) + UAE spare parts",
        requirement_level: "mandatory",
      },
    ],
    mandatory_constraints: [
      ...
      "Minimum 10 bar working pressure rating",
      ...
      "Two-year UAE warranty and UAE spare-parts support",
    ],
    preferred_constraints: [
