...
const AUTHORIZATION_ID =
  "OWNER-SLICE3-OPENROUTER-CREDENTIAL-GATE-2026-08-30-V3";
const EXECUTION_SIGNAL = "I_AUTHORIZE_ONE_OPENROUTER_CREDENTIAL_STATUS_GET_V3";
const SESSION_ID = "v6-A06CD705B4D7733589780E4C";
const AUTHORIZATION_SHA256 =
  "003E98777230AA95D94E208C748FBFF2AC7B63786B5436262A47FB382EB29594";
...
const DEFAULTS = Object.freeze({
  authorizationPath: resolve(
    "governance/slice3-openrouter-credential-successor-authorization.v3.json",
  ),
  credentialPath: resolve("APIKeys.md"),
  executorPath: resolve(
    "scripts/qualify-slice3-openrouter-credential-successor-v3.mjs",
  ),
...
function validateAuthorization(value) {
  if (
    value?.schemaVersion !==
      "matchbase.slice3-openrouter-credential-successor-authorization/v3" ||
    ...
    value.ownerCeiling?.remainingCostUsdBeforeV3 !== 99.9665135 ||
...
export async function assessCredentialGate(overrides = {}) {
  ...
  return Object.freeze({
    schemaVersion:
      "matchbase.slice3-openrouter-credential-successor-preflight/v3",
    disposition:
      blockers.length === 0
...
export async function executeCredentialGate({
  ...
  await writeJsonExclusive(join(stateDirectory, "00-authorization.json"), {
    schemaVersion:
      "matchbase.slice3-openrouter-credential-successor-session/v3",
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
    predecessorSessionId: PREDECESSOR_SESSION_ID,
    maximumCredentialGets: 1,
  ...
  await writeJsonExclusive(join(stateDirectory, "01-key-get-reserved.json"), {
    schemaVersion:
      "matchbase.slice3-openrouter-credential-successor-reservation/v3",
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
  ...
  await writeJsonExclusive(join(stateDirectory, "03-terminal-manifest.json"), {
    schemaVersion:
      "matchbase.slice3-openrouter-credential-successor-manifest/v3",
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
  ...
  return Object.freeze({
    schemaVersion:
      "matchbase.slice3-openrouter-credential-successor-execution/v3",
    disposition: result.disposition,
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
...
export const SLICE3_OPENROUTER_CREDENTIAL_SUCCESSOR_V3 = Object.freeze({
  authorizationId: AUTHORIZATION_ID,
