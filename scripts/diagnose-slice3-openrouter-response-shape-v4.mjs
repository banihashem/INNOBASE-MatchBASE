...
const SIGNAL = "I_AUTHORIZE_ONE_SYNTHETIC_OPENROUTER_RESPONSE_SHAPE_CALL_V4";
const SESSION_DIRECTORY = resolve(
  "C:/INNOBASE/MatchBASE/01_Product_Management/.slice3-staging-live-qualification-state/v6-DIAG4-2440CD18C4EE192F",
);
...
async function main() {
  ...
  process.stdout.write(
    `${JSON.stringify({
      schemaVersion: "matchbase.slice3-openrouter-response-shape-diagnostic/v4",
      syntheticOnly: true,
