...
const SIGNAL = "I_AUTHORIZE_TWO_SYNTHETIC_RESPONSE_SHAPE_CALLS_V1";
const SESSION_DIRECTORY = resolve(
  "C:/INNOBASE/MatchBASE/01_Product_Management/.slice3-staging-live-qualification-state/v6-DIAG-792DD17BC62F4B1E",
);
...
async function main() {
  ...
  process.stdout.write(
    `${JSON.stringify({
      schemaVersion: "matchbase.slice3-response-shape-diagnostic/v1",
      syntheticOnly: true,
