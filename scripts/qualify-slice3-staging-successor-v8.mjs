...
const AUTHORIZATION_ID =
  "OWNER-SLICE3-STAGING-LIVE-QUALIFICATION-2026-08-30-V8";
const EXECUTION_SIGNAL = "I_AUTHORIZE_SYNTHETIC_STAGING_QUALIFICATION_V8";
const AUTHORIZATION_SHA256 =
  "9DD781BA62853B9D8E9A91316387DDA8311ACBB34256BB9B6A587FBD5BCD1343";
const PRODUCTION_POLICY_SHA256 =
  "46FCAF0C2D2B66F8BAB8526C48E448A24B2E9F65B065AAA99135CA6AF048DB23";
const PREDECESSOR_SESSION_ID = "v6-2E66ED1C86D901D252F99B5E";
const PREDECESSOR_LEDGER_SHA256 =
  "0FAA7A2C479734B36B7AE76DF855DBBEE5A5A488641363412A91EB1FCE0190F0";
...
const SESSION_ID = "v6-8AC279688809D6034291989E";
const MAX_EXTERNAL_HTTP_CALLS = 50;
const MAX_MODEL_POSTS = 2;
const MAX_COST_USD = 99.0959775;
const PRIOR_MODEL_POSTS = 19;
const PRIOR_COST_USD = 0.9040225;

const DEFAULTS = Object.freeze({
  authorizationPath: resolve(
    "governance/slice3-staging-live-qualification-successor-authorization.v8.json",
  ),
  productionPolicyPath: resolve("config/slice3/research-route-policy.v1.json"),
  credentialPath: resolve("APIKeys.md"),
  executorPath: resolve("scripts/qualify-slice3-staging-successor-v8.mjs"),
...
function validateAuthorization(value) {
  if (
    value?.schemaVersion !==
      "matchbase.slice3-staging-live-qualification-successor-authorization/v8" ||
    ...
    value.predecessor?.costConsumedUsd !== 0 ||
    value.predecessor?.cumulativeProviderModelPosts !== 19 ||
    value.predecessor?.cumulativeConservativeCostUsd !== 0.9040225 ||
    ...
    value.ownerCeiling?.remainingProviderCallsBeforeV8 !== 31 ||
    value.ownerCeiling?.remainingCostUsdBeforeV8 !== MAX_COST_USD ||
    ...
    value.requestContract?.openRouterSeed !== 137 ||
    ...
    value.accounting?.providerModelPostsBeforeV8 !== PRIOR_MODEL_POSTS ||
    value.accounting?.conservativeCostUsdBeforeV8 !== PRIOR_COST_USD ||
    value.accounting?.diagnosticProviderModelPostsAfterV5 !== 2 ||
    value.accounting?.diagnosticConservativeCostUsdAfterV5 !== 0.043008 ||
...
export async function assessSuccessor(overrides = {}) {
  ...
  return Object.freeze({
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-preflight/v8",
    disposition:
...
function sanitizedFailure(error, routePath, counters) {
  ...
  return Object.freeze({
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-failure/v8",
...
export async function executeSuccessor({
  ...
  await writeJsonExclusive(join(stateDirectory, "00-authorization.json"), {
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-session/v8",
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
    predecessorSessionId: PREDECESSOR_SESSION_ID,
    syntheticOnly: true,
  ...
  for (
    ...
    await writeJsonExclusive(
      ...
      {
        schemaVersion:
          "matchbase.slice3-staging-live-qualification-successor-reservation/v8",
        authorizationId: AUTHORIZATION_ID,
        sessionId: SESSION_ID,
        callNumber: index + 1,
  ...
  await writeJsonExclusive(join(stateDirectory, "05-terminal-summary.json"), {
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-terminal/v8",
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
  ...
  if (failures.length > 0) {
    ...
    return Object.freeze({
      schemaVersion:
        "matchbase.slice3-staging-live-qualification-successor-execution/v8",
      disposition: "FAIL",
      authorizationId: AUTHORIZATION_ID,
      sessionId: SESSION_ID,
...
export const SLICE3_STAGING_SUCCESSOR_V8_CONSTANTS = Object.freeze({
  authorizationId: AUTHORIZATION_ID,
