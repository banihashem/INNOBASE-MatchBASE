          ...
          <p>
            {draftInitializationFailed
              ...
              : workflowProgress?.phase === "user_cancelled"
                ...
                : workflowError.includes("MB-409-FOCUS-CONTEXT")
                  ? "The saved findings could not fit the next model request, so that request was not sent. Your request and completed results are retained; this capacity issue requires a system adjustment, not a rewrite of your request."
