...
function syntheticCandidate(index: number): {
  ...
  return {
    candidate: {
      ...
      dimensionScores: {
        category_product_fit: 90 - index,
        compliance_certification_fit: 85 - index,
        volume_capacity_fit: 88 - index,
        price_tier_fit: 82 - index,
        positioning_brand_fit: 84 - index,
        geographic_reach_fit: 86 - index,
      },
