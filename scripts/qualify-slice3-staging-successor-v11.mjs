...
const AUTHORIZATION_ID =
  "OWNER-SLICE3-STAGING-LIVE-QUALIFICATION-2026-08-30-V11";
const EXECUTION_SIGNAL = "I_AUTHORIZE_SYNTHETIC_STAGING_QUALIFICATION_V11";
const AUTHORIZATION_SHA256 =
  "2091758A99BC3F35842CD4AD4A9DC07089C8847A3BBCF344AB1765C90E26AC35";
const PRODUCTION_POLICY_SHA256 =
  "46FCAF0C2D2B66F8BAB8526C48E448A24B2E9F65B065AAA99135CA6AF048DB23";
const PREDECESSOR_SESSION_ID = "v6-DAE14A0DA978EF3A9E7E2FB4";
const PREDECESSOR_LEDGER_SHA256 =
  "E88CDE85949B01D6A7D7DD008B37F26AEB6DABF8683C702FA0302D5AF6B4DD92";
...
const SESSION_ID = "v6-6E67532C6108E5E5F7C17003";
const MAX_EXTERNAL_HTTP_CALLS = 50;
const MAX_MODEL_POSTS = 2;
const MAX_COST_USD = 98.3339295;
const PRIOR_MODEL_POSTS = 26;
const PRIOR_COST_USD = 1.6660705;

const DEFAULTS = Object.freeze({
  authorizationPath: resolve(
    "governance/slice3-staging-live-qualification-successor-authorization.v11.json",
  ),
  productionPolicyPath: resolve("config/slice3/research-route-policy.v1.json"),
  credentialPath: resolve("APIKeys.md"),
  executorPath: resolve("scripts/qualify-slice3-staging-successor-v11.mjs"),
...
function validateAuthorization(value) {
  if (
    value?.schemaVersion !==
      "matchbase.slice3-staging-live-qualification-successor-authorization/v11" ||
    ...
    value.predecessor?.cumulativeProviderModelPosts !== 26 ||
    value.predecessor?.cumulativeConservativeCostUsd !== 1.6660705 ||
    ...
    value.ownerCeiling?.remainingProviderCallsBeforeV11 !== 24 ||
    value.ownerCeiling?.remainingCostUsdBeforeV11 !== MAX_COST_USD ||
    ...
    value.requestContract?.openRouterGenerationMetadataMaximumGets !== 3 ||
    ...
    value.accounting?.providerModelPostsBeforeV11 !== PRIOR_MODEL_POSTS ||
    value.accounting?.conservativeCostUsdBeforeV11 !== PRIOR_COST_USD ||
...
export async function assessSuccessor(overrides = {}) {
  ...
  return Object.freeze({
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-preflight/v11",
    disposition:
...
function sanitizedFailure(error, routePath, counters) {
  ...
  return Object.freeze({
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-failure/v11",
...
export async function executeSuccessor({
  ...
  await writeJsonExclusive(join(stateDirectory, "00-authorization.json"), {
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-session/v11",
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
    predecessorSessionId: PREDECESSOR_SESSION_ID,
    syntheticOnly: true,
  ...
  for (
    ...
    await writeJsonExclusive(
      ...
      {
        schemaVersion:
          "matchbase.slice3-staging-live-qualification-successor-reservation/v11",
        authorizationId: AUTHORIZATION_ID,
        sessionId: SESSION_ID,
        callNumber: index + 1,
  ...
  await writeJsonExclusive(join(stateDirectory, "05-terminal-summary.json"), {
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-terminal/v11",
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
  ...
  if (failures.length > 0) {
    ...
    return Object.freeze({
      schemaVersion:
        "matchbase.slice3-staging-live-qualification-successor-execution/v11",
      disposition: "FAIL",
      authorizationId: AUTHORIZATION_ID,
      sessionId: SESSION_ID,
...
export const SLICE3_STAGING_SUCCESSOR_V11_CONSTANTS = Object.freeze({
  authorizationId: AUTHORIZATION_ID,
