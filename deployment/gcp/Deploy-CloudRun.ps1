...
param(
  ...
  [Parameter(Mandatory)][ValidatePattern('^[a-f0-9]{64}$')][string]$PdfTemplateSha256,
  [Parameter(Mandatory)][ValidatePattern('^[a-f0-9]{64}$')][string]$PdfFontSha256,
  [Parameter(Mandatory)][ValidatePattern('^[a-f0-9]{64}$')][string]$PdfToolchainSha256,
