...
const AUTHORIZATION_ID =
  "OWNER-SLICE3-STAGING-LIVE-QUALIFICATION-2026-08-30-V10";
const EXECUTION_SIGNAL = "I_AUTHORIZE_SYNTHETIC_STAGING_QUALIFICATION_V10";
const AUTHORIZATION_SHA256 =
  "F5ABB641C604F37D2EB3252AF29D50C36172DC4CE6004502C4617E62B0F28F02";
const PRODUCTION_POLICY_SHA256 =
  "46FCAF0C2D2B66F8BAB8526C48E448A24B2E9F65B065AAA99135CA6AF048DB23";
const PREDECESSOR_SESSION_ID = "v6-140C181D2FF89EE8A41044FB";
const PREDECESSOR_LEDGER_SHA256 =
  "FF16092DE09CD4FDF873CC83D8E91A803A48CDD332E9FD5BD594F11AC0BD8B64";
...
const SESSION_ID = "v6-DAE14A0DA978EF3A9E7E2FB4";
const MAX_EXTERNAL_HTTP_CALLS = 50;
const MAX_MODEL_POSTS = 2;
const MAX_COST_USD = 98.5756575;
const PRIOR_MODEL_POSTS = 24;
const PRIOR_COST_USD = 1.4243425;

const DEFAULTS = Object.freeze({
  authorizationPath: resolve(
    "governance/slice3-staging-live-qualification-successor-authorization.v10.json",
  ),
  productionPolicyPath: resolve("config/slice3/research-route-policy.v1.json"),
  credentialPath: resolve("APIKeys.md"),
  executorPath: resolve("scripts/qualify-slice3-staging-successor-v10.mjs"),
...
function validateAuthorization(value) {
  if (
    value?.schemaVersion !==
      "matchbase.slice3-staging-live-qualification-successor-authorization/v10" ||
    ...
    value.predecessor?.cumulativeProviderModelPosts !== 23 ||
    value.predecessor?.cumulativeConservativeCostUsd !== 1.3874785 ||
    ...
    value.ownerCeiling?.remainingProviderCallsBeforeV10 !== 26 ||
    value.ownerCeiling?.remainingCostUsdBeforeV10 !== MAX_COST_USD ||
    ...
    value.accounting?.providerModelPostsBeforeV10 !== PRIOR_MODEL_POSTS ||
    value.accounting?.conservativeCostUsdBeforeV10 !== PRIOR_COST_USD ||
...
export async function assessSuccessor(overrides = {}) {
  ...
  return Object.freeze({
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-preflight/v10",
    disposition:
...
function sanitizedFailure(error, routePath, counters) {
  ...
  return Object.freeze({
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-failure/v10",
...
export async function executeSuccessor({
  ...
  await writeJsonExclusive(join(stateDirectory, "00-authorization.json"), {
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-session/v10",
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
    predecessorSessionId: PREDECESSOR_SESSION_ID,
    syntheticOnly: true,
  ...
  for (
    ...
    await writeJsonExclusive(
      ...
      {
        schemaVersion:
          "matchbase.slice3-staging-live-qualification-successor-reservation/v10",
        authorizationId: AUTHORIZATION_ID,
        sessionId: SESSION_ID,
        callNumber: index + 1,
  ...
  await writeJsonExclusive(join(stateDirectory, "05-terminal-summary.json"), {
    schemaVersion:
      "matchbase.slice3-staging-live-qualification-successor-terminal/v10",
    authorizationId: AUTHORIZATION_ID,
    sessionId: SESSION_ID,
  ...
  if (failures.length > 0) {
    ...
    return Object.freeze({
      schemaVersion:
        "matchbase.slice3-staging-live-qualification-successor-execution/v10",
      disposition: "FAIL",
      authorizationId: AUTHORIZATION_ID,
      sessionId: SESSION_ID,
...
export const SLICE3_STAGING_SUCCESSOR_V10_CONSTANTS = Object.freeze({
  authorizationId: AUTHORIZATION_ID,
